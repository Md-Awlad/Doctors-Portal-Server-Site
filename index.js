...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.hbnr1tl.mongodb.net/?retryWrites=true&w=majority`;
...
async function run() {
  try {
    ...
    //Contact Collection
    const contactCollection = client.db("doctors_portal").collection("contact");
    ...
    app.get("/available", async (req, res) => {
      ...
      //Step 2: get the booking for the day.
